...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<Language, Map<String, String>> _translations = {
    Language.fr: {
      ...
      'auth.forgotPasswordBtn': 'Envoyer le code',
      'auth.forgotPasswordSent':
          'Si un compte existe avec cet email, un code à 6 chiffres a été envoyé.',
      'auth.codeLabel': 'Code à 6 chiffres',
      'auth.enterCode': 'Entrez le code envoyé à votre email.',
      'auth.codeInvalid': 'Code invalide ou expiré',
      'auth.tooManyAttempts': 'Trop de tentatives, redemandez un code',
      ...
      'premium.lifetime': 'À vie',
      'premium.perMonth': '/mois',
      'premium.perYear': '/an',
      'premium.bestValue': 'Meilleure offre',
      'premium.savePercent': 'Économisez {percent}%',
      'premium.freeTrialDays': 'Essai gratuit de {days} jours',
      'premium.thenPrice': 'puis {price}',
      'premium.cancelAnytime': 'Annulable à tout moment',
      'premium.subscribe': 'S\'abonner',
      'premium.purchase': 'Acheter',
      'premium.terms': 'Conditions',
      'premium.privacy': 'Confidentialité',
      'premium.disclaimer': 'Le paiement sera prélevé sur votre compte Apple ID à la confirmation de l\'achat. L\'abonnement se renouvelle automatiquement sauf annulation au moins 24 heures avant la fin de la période en cours. Votre compte sera débité du renouvellement dans les 24 heures précédant la fin de la période en cours. Vous pouvez gérer et annuler vos abonnements dans les réglages de votre compte sur l\'App Store après l\'achat.',
    ...
    Language.en: {
      ...
      'auth.forgotPasswordBtn': 'Send code',
      'auth.forgotPasswordSent':
          'If an account exists with this email, a 6-digit code has been sent.',
      'auth.codeLabel': '6-digit code',
      'auth.enterCode': 'Enter the code we sent to your email.',
      'auth.codeInvalid': 'Invalid or expired code',
      'auth.tooManyAttempts': 'Too many attempts, request a new code',
      ...
      'premium.savePercent': 'Save {percent}%',
      'premium.freeTrialDays': '{days}-day free trial',
      'premium.thenPrice': 'then {price}',
      'premium.cancelAnytime': 'Cancel anytime',
      'premium.subscribe': 'Subscribe',
      'premium.purchase': 'Purchase',
      'premium.terms': 'Terms',
      'premium.privacy': 'Privacy',
      'premium.disclaimer': 'Payment will be charged to your Apple ID account at confirmation of purchase. Subscription automatically renews unless it is canceled at least 24 hours before the end of the current period. Your account will be charged for renewal within 24 hours prior to the end of the current period. You can manage and cancel your subscriptions by going to your account settings on the App Store after purchase.',
      'settings.premium': 'Premium',
    ...
    Language.zhCN: {
      ...
      'auth.forgotPasswordBtn': '发送验证码',
      'auth.forgotPasswordSent': '如果该邮箱存在账号，已发送 6 位验证码。',
      'auth.codeLabel': '6 位验证码',
      'auth.enterCode': '请输入发送到您邮箱的验证码。',
      'auth.codeInvalid': '验证码无效或已过期',
      'auth.tooManyAttempts': '尝试次数过多，请重新申请验证码',
      ...
      'premium.perMonth': '/月',
      'premium.perYear': '/年',
      'premium.bestValue': '最划算',
      'premium.savePercent': '节省 {percent}%',
      'premium.freeTrialDays': '{days} 天免费试用',
      'premium.thenPrice': '之后 {price}',
      'premium.cancelAnytime': '随时取消',
      'premium.subscribe': '订阅',
      'premium.purchase': '购买',
      'premium.terms': '条款',
      'premium.privacy': '隐私',
      'premium.disclaimer': '购买确认后，付款将从您的 Apple ID 账户中扣除。除非在当前订阅期结束前至少 24 小时取消，否则订阅将自动续订。您的账户将在当前周期结束前 24 小时内扣除续订费用。购买后，您可以前往 App Store 账户设置管理和取消订阅。',
    ...
    Language.zhTW: {
      ...
      'auth.forgotPasswordBtn': '發送驗證碼',
      'auth.forgotPasswordSent': '如果該信箱存在帳號，已發送 6 位驗證碼。',
      'auth.codeLabel': '6 位驗證碼',
      'auth.enterCode': '請輸入發送到您信箱的驗證碼。',
      'auth.codeInvalid': '驗證碼無效或已過期',
      'auth.tooManyAttempts': '嘗試次數過多，請重新申請驗證碼',
      ...
      'premium.perYear': '/年',
      'premium.bestValue': '最划算',
      'premium.savePercent': '節省 {percent}%',
      'premium.freeTrialDays': '{days} 天免費試用',
      'premium.thenPrice': '之後 {price}',
      'premium.cancelAnytime': '隨時取消',
      'premium.subscribe': '訂閱',
      'premium.purchase': '購買',
      'premium.terms': '條款',
      'premium.privacy': '隱私',
      'premium.disclaimer': '購買確認後，付款將從您的 Apple ID 帳戶中扣除。除非在當前訂閱期結束前至少 24 小時取消，否則訂閱將自動續訂。您的帳戶將在當前週期結束前 24 小時內扣除續訂費用。購買後，您可以前往 App Store 帳戶設定管理和取消訂閱。',
